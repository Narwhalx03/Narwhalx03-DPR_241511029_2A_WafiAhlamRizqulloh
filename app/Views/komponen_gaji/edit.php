            ...
            <div class="card-body">
                ...
                <form action="<?= site_url('admin/komponengaji/update/'.$komponen['id_komponen_gaji']) ?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="id_komponen_gaji" id="id_komponen_gaji" value="<?= old('id_komponen_gaji', $komponen['id_komponen_gaji']) ?>" readonly>
                    </div>

                    <div class="mb-3">
                        <label for="nama_komponen" class="form-label">Nama Komponen</label>
                        <input type="text" class="form-control" name="nama_komponen" id="nama_komponen" value="<?= old('nama_komponen', $komponen['nama_komponen']) ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="nominal" id="nominal" step="1000" value="<?= old('nominal', $komponen['nominal']) ?>">
                    </div>
